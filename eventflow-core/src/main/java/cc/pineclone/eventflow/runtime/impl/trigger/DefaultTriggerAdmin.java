...
public class DefaultTriggerAdmin implements TriggerAdmin {
     ...
     */
    private final Map<ComponentId, Integer> activeCounts = new HashMap<>();
    ...
    @Override
    public ComponentId deploy(TriggerDefinition definition) {
        Objects.requireNonNull(definition, "definition");
        return registry.register(definition);
    }

    @Override
    public void undeploy(ComponentId rootId) {
    ...
    @Override
    public synchronized void activate(ComponentId rootId) {
        Objects.requireNonNull(rootId, "rootId");
    ...
    @Override
    public synchronized void deactivate(ComponentId rootId) {
        Objects.requireNonNull(rootId, "rootId");
