...
//            TriggerMode policy = dto.activateMethod();  /* 激活模式 */
//            Key activatekey = dto.activateKey();  /* 激活热键 */
//
//            Trigger trigger;
//            TriggerIdentity defaultIdentity = TriggerIdentity.of(policy, activatekey);
//            if (dto.enableSafetyKey()) {  /* 启用保险键 */
//                trigger = TriggerFactory.composite(defaultIdentity, TriggerIdentity.of(policy, dto.safetyKey()));
...
//            TriggerMode policy = dto.activateMethod();  /* 激活模式 切换执行 or 按住执行 */
//            Key activatekey = dto.activateKey();  /* 激活热键 */
//
//            Trigger trigger;
//            TriggerIdentity defaultIdentity = TriggerIdentity.of(policy, activatekey);
